...
import it.thedarksword.basement.api.bukkit.events.BasementNewServerFound;
import it.thedarksword.basement.api.bukkit.events.BasementServerRemoved;
import it.thedarksword.basement.api.commands.impl.CreateServerMessage;
...
public class ServerRancher implements Listener {
    ...
    protected void startServer(int many) {
        for (int i = 0; i != many; i++) {
            ...
            Basement.redis().publishMessage(new CreateServerMessage(modeName + "_instance_" + index));
        }
    }
